...
const faqs = [
  ...
  },
  {
    ...
    a: '<strong>Yes!</strong> We offer flexible financing options so you can get the roof you need without breaking the bank. Get your free estimate and we\'ll discuss payment options that work for your budget.'
  }
]
</script>
